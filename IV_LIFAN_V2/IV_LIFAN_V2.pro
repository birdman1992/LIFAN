...
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/driver/can/ -lcontrolcan
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/driver/can/ -lcontrolcan
else:unix: LIBS += -L$$PWD/driver/can/ -lcontrolcan
