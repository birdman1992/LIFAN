...
public:
	...
	*///--------------------------------------
	typedef std::vector<uint8_t> SutpPayload;
	...
	*///--------------------------------------
	 ...
	 *///-------------------------------------
	typedef boost::function<bool(std::istream& is, size_t len)> MessageHandler;
...
public:
	...
	*///--------------------------------------
	IbeoSutpInterface (MessageHandler msgHandler,
	                   uint64_t timeout = sutpDefaultTimeout,
	                   uint32_t errResetLimit = defaultErrorResetLimit);
